...
| **Assisted Installer CLI** (`aicli`) | Latest | Cluster deployment | Complete Installation | Install with `pip3 install aicli` or from [GitHub](https://github.com/karmab/aicli) |
