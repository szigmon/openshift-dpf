...
all: verify-files check-cluster create-vms prepare-manifests cluster-install wait-for-ready update-etc-hosts kubeconfig deploy-dpf prepare-dpu-files deploy-dpu-services enable-ovn-injector
